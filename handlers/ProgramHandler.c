...
#define __PYX_HAVE__ProgramHandler
#define __PYX_HAVE_API__ProgramHandler
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "ProgramHandler" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "ProgramHandler"
extern int __pyx_module_is_main_ProgramHandler;
int __pyx_module_is_main_ProgramHandler = 0;

/* Implementation of "ProgramHandler" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_14ProgramHandler_handle(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_cmd, PyObject *__pyx_v_args, PyObject *__pyx_v_eval_expr); /* proto */
...
#define __pyx_kp_u_Note_Program_Main_If_Else_Loop __pyx_string_tab[1]
#define __pyx_kp_u_Program __pyx_string_tab[2]
#define __pyx_kp_u_Program_Not_requires_1_argument __pyx_string_tab[3]
#define __pyx_kp_u_Unknown_Program_command __pyx_string_tab[4]
#define __pyx_kp_u__2 __pyx_string_tab[5]
#define __pyx_kp_u_error __pyx_string_tab[6]
#define __pyx_kp_u_handlers_ProgramHandler_py __pyx_string_tab[7]
#define __pyx_n_u_Not __pyx_string_tab[8]
#define __pyx_n_u_ProgramHandler __pyx_string_tab[9]
...
#define __pyx_n_u_error_handler __pyx_string_tab[17]
#define __pyx_n_u_eval_expr __pyx_string_tab[18]
#define __pyx_n_u_func __pyx_string_tab[19]
#define __pyx_n_u_handle __pyx_string_tab[20]
#define __pyx_n_u_inner __pyx_string_tab[21]
...
#define __pyx_kp_b_iso88591_4s_s_6_A_aq_D_Yaq_4t1A_aq_az_s __pyx_string_tab[34]
...
/* Python wrapper */
static PyObject *__pyx_pw_14ProgramHandler_1handle(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_14ProgramHandler_handle, "\n    Handle Program.* commands that are expressions (not blocks).\n    \n    Args:\n        cmd (str): The command name (e.g., \"Not\")\n        args (list[str]): Raw string arguments\n        eval_expr: Reference to the eval_expr function for recursive evaluation\n        \n    Returns:\n        Any: The result of the command (e.g., boolean for Not)\n        \n    Raises:\n        RuntimeErrorICTL: On errors\n    ");
static PyMethodDef __pyx_mdef_14ProgramHandler_1handle = {"handle", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_14ProgramHandler_1handle, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_14ProgramHandler_handle};
static PyObject *__pyx_pw_14ProgramHandler_1handle(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "handle", 0) < (0)) __PYX_ERR(0, 9, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("handle", 1, 3, 3, i); __PYX_ERR(0, 9, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("handle", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("ProgramHandler.handle", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14ProgramHandler_handle(__pyx_self, __pyx_v_cmd, __pyx_v_args, __pyx_v_eval_expr);
...
static PyObject *__pyx_pf_14ProgramHandler_handle(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_cmd, PyObject *__pyx_v_args, PyObject *__pyx_v_eval_expr) {
...
*/
      __pyx_t_4 = (__Pyx_PyUnicode_Equals(__pyx_v_cmd, __pyx_mstate_global->__pyx_n_u_Not, Py_EQ)); if (unlikely((__pyx_t_4 < 0))) __PYX_ERR(0, 25, __pyx_L3_error)
      if (likely(__pyx_t_4)) {

        /* "ProgramHandler.py":26
 *     try:
 *         if cmd == "Not":
 *             if len(args) != 1:             # <<<<<<<<<<<<<<
 *                 raise RuntimeErrorICTL("Program.Not requires 1 argument: Program.Not(condition)")
 *             inner = args[0]
*/
        __pyx_t_5 = PyObject_Length(__pyx_v_args); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 26, __pyx_L3_error)
        __pyx_t_4 = (__pyx_t_5 != 1);
        if (unlikely(__pyx_t_4)) {

          /* "ProgramHandler.py":27
 *         if cmd == "Not":
 *             if len(args) != 1:
 *                 raise RuntimeErrorICTL("Program.Not requires 1 argument: Program.Not(condition)")             # <<<<<<<<<<<<<<
 *             inner = args[0]
...
*/
          __pyx_t_7 = NULL;
          __Pyx_GetModuleGlobalName(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_RuntimeErrorICTL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 27, __pyx_L3_error)
          ...
          #endif
          {
            PyObject *__pyx_callargs[2] = {__pyx_t_7, __pyx_mstate_global->__pyx_kp_u_Program_Not_requires_1_argument};
...
*/
        __pyx_t_6 = __Pyx_GetItemInt(__pyx_v_args, 0, long, 1, __Pyx_PyLong_From_long, 0, 0, 1, 1, __Pyx_ReferenceSharing_FunctionArgument); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 28, __pyx_L3_error)
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_v_inner = __pyx_t_6;
        __pyx_t_6 = 0;

        /* "ProgramHandler.py":29
 *                 raise RuntimeErrorICTL("Program.Not requires 1 argument: Program.Not(condition)")
 *             inner = args[0]
 *             result = eval_expr(inner)             # <<<<<<<<<<<<<<
 *             # Convert result to boolean and negate
...
*/
        ...
        #endif
        {
          PyObject *__pyx_callargs[2] = {__pyx_t_8, __pyx_v_inner};
...
*/
        ...
        __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_v_result); if (unlikely((__pyx_t_4 < 0))) __PYX_ERR(0, 31, __pyx_L3_error)
        __pyx_t_6 = __Pyx_PyBool_FromLong((!(!(!__pyx_t_4)))); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 31, __pyx_L3_error)
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_r = __pyx_t_6;
        __pyx_t_6 = 0;
...
*/
      /*else*/ {
        __pyx_t_7 = NULL;
        __Pyx_GetModuleGlobalName(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_RuntimeErrorICTL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 34, __pyx_L3_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_10 = __Pyx_PyObject_FormatSimple(__pyx_v_cmd, __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 34, __pyx_L3_error)
        __Pyx_GOTREF(__pyx_t_10);
        __pyx_t_11[0] = __pyx_mstate_global->__pyx_kp_u_Unknown_Program_command;
        __pyx_t_11[1] = __pyx_t_10;
        __pyx_t_11[2] = __pyx_mstate_global->__pyx_kp_u_Note_Program_Main_If_Else_Loop;
        __pyx_t_12 = __Pyx_PyUnicode_Join(__pyx_t_11, 3, 25 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_10) + 92, 127 | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_10));
...
*/
    __Pyx_ErrFetch(&__pyx_t_6, &__pyx_t_8, &__pyx_t_12);
    __Pyx_GetModuleGlobalName(__pyx_t_7, __pyx_mstate_global->__pyx_n_u_RuntimeErrorICTL); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 36, __pyx_L5_except_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_13 = __Pyx_PyErr_GivenExceptionMatches(__pyx_t_6, __pyx_t_7);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_ErrRestore(__pyx_t_6, __pyx_t_8, __pyx_t_12);
    __pyx_t_6 = 0; __pyx_t_8 = 0; __pyx_t_12 = 0;
    if (__pyx_t_13) {
      __Pyx_AddTraceback("ProgramHandler.handle", __pyx_clineno, __pyx_lineno, __pyx_filename);
      if (__Pyx_GetException(&__pyx_t_12, &__pyx_t_8, &__pyx_t_6) < 0) __PYX_ERR(0, 36, __pyx_L5_except_error)
      __Pyx_XGOTREF(__pyx_t_12);
      __Pyx_XGOTREF(__pyx_t_8);
      __Pyx_XGOTREF(__pyx_t_6);

      /* "ProgramHandler.py":37
 * 
 *     except RuntimeErrorICTL:
 *         raise             # <<<<<<<<<<<<<<
 *     except Exception as e:
...
*/
      ...
      __Pyx_ErrRestoreWithState(__pyx_t_12, __pyx_t_8, __pyx_t_6);
      __pyx_t_12 = 0;  __pyx_t_8 = 0;  __pyx_t_6 = 0; 
      __PYX_ERR(0, 37, __pyx_L5_except_error)
    }

    /* "ProgramHandler.py":38
 *     except RuntimeErrorICTL:
 *         raise
 *     except Exception as e:             # <<<<<<<<<<<<<<
 *         raise RuntimeErrorICTL(f"Program.{cmd} error: {str(e)}")
*/
    ...
    if (__pyx_t_13) {
      __Pyx_AddTraceback("ProgramHandler.handle", __pyx_clineno, __pyx_lineno, __pyx_filename);
      if (__Pyx_GetException(&__pyx_t_6, &__pyx_t_8, &__pyx_t_12) < 0) __PYX_ERR(0, 38, __pyx_L5_except_error)
      __Pyx_XGOTREF(__pyx_t_6);
      __Pyx_XGOTREF(__pyx_t_8);
      __Pyx_XGOTREF(__pyx_t_12);
      __Pyx_INCREF(__pyx_t_8);
      ...
      /*try:*/ {
        ...
        /* "ProgramHandler.py":39
 *         raise
 *     except Exception as e:
 *         raise RuntimeErrorICTL(f"Program.{cmd} error: {str(e)}")             # <<<<<<<<<<<<<<
*/
        __pyx_t_10 = NULL;
        __Pyx_GetModuleGlobalName(__pyx_t_14, __pyx_mstate_global->__pyx_n_u_RuntimeErrorICTL); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 39, __pyx_L18_error)
        __Pyx_GOTREF(__pyx_t_14);
        __pyx_t_15 = __Pyx_PyObject_FormatSimple(__pyx_v_cmd, __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 39, __pyx_L18_error)
        __Pyx_GOTREF(__pyx_t_15);
        __pyx_t_16 = __Pyx_PyObject_Unicode(__pyx_v_e); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 39, __pyx_L18_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_17[0] = __pyx_mstate_global->__pyx_kp_u_Program;
        __pyx_t_17[1] = __pyx_t_15;
        __pyx_t_17[2] = __pyx_mstate_global->__pyx_kp_u_error;
        __pyx_t_17[3] = __pyx_t_16;
        __pyx_t_18 = __Pyx_PyUnicode_Join(__pyx_t_17, 4, 8 * 2 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_15) + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_16), 127 | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_15) | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_16));
        if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 39, __pyx_L18_error)
        ...
        #endif
        {
          ...
          if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 39, __pyx_L18_error)
          __Pyx_GOTREF(__pyx_t_7);
        }
        __Pyx_Raise(__pyx_t_7, 0, 0, 0);
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __PYX_ERR(0, 39, __pyx_L18_error)
      }
...
static int __pyx_pymod_exec_ProgramHandler(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ProgramHandler},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_ProgramHandler(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ProgramHandler(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ProgramHandler(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ProgramHandler' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "ProgramHandler" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_ProgramHandler", 0);
  ...
  if (__pyx_module_is_main_ProgramHandler) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ProgramHandler")) {
      if (unlikely((PyDict_SetItemString(modules, "ProgramHandler", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_error_handler, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
 ...
 *     Handle Program.* commands that are expressions (not blocks).
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_14ProgramHandler_1handle, 0, __pyx_mstate_global->__pyx_n_u_handle, NULL, __pyx_mstate_global->__pyx_n_u_ProgramHandler, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_handle, __pyx_t_2) < (0)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init ProgramHandler", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init ProgramHandler");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{92},{8},{55},{25},{1},{8},{26},{3},{14},{20},{16},{4},{18},{18},{3},{1},{13},{9},{8},{6},{5},{13},{5},{8},{10},{8},{3},{12},{6},{12},{10},{8},{6},{118}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd