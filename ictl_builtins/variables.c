...
static const char __pyx_k_Global_variable_storage_for_ICTL[] = "Global variable storage for ICTL programs.";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9variables_new_variable(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_name); /* proto */
...
#define __pyx_kp_u_Variable __pyx_string_tab[1]
#define __pyx_kp_u_already_exists __pyx_string_tab[2]
#define __pyx_kp_u_ictl_builtins_variables_py __pyx_string_tab[3]
...
#define __pyx_n_u_name_2 __pyx_string_tab[13]
#define __pyx_n_u_new_variable __pyx_string_tab[14]
...
#define __pyx_n_u_variables __pyx_string_tab[21]
#define __pyx_kp_b_iso88591_uCq_l_aq_Qha __pyx_string_tab[22]
...
/* Python wrapper */
static PyObject *__pyx_pw_9variables_1new_variable(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_9variables_new_variable, "Create a new variable (deprecated - variables are auto-created on assignment).");
static PyMethodDef __pyx_mdef_9variables_1new_variable = {"new_variable", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9variables_1new_variable, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_9variables_new_variable};
static PyObject *__pyx_pw_9variables_1new_variable(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("new_variable (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "new_variable", 0) < (0)) __PYX_ERR(0, 11, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("new_variable", 1, 1, 1, i); __PYX_ERR(0, 11, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("new_variable", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("variables.new_variable", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9variables_new_variable(__pyx_self, __pyx_v_name);
...
static PyObject *__pyx_pf_9variables_new_variable(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_name) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("new_variable", 0);
 ...
 *     variables[name] = None
*/
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_variables); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = (__Pyx_PySequence_ContainsTF(__pyx_v_name, __pyx_t_1, Py_EQ)); if (unlikely((__pyx_t_2 < 0))) __PYX_ERR(0, 13, __pyx_L1_error)
...
*/
    __pyx_t_3 = NULL;
    __pyx_t_4 = __Pyx_PyObject_FormatSimple(__pyx_v_name, __pyx_mstate_global->__pyx_empty_unicode); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5[0] = __pyx_mstate_global->__pyx_kp_u_Variable;
    __pyx_t_5[1] = __pyx_t_4;
    __pyx_t_5[2] = __pyx_mstate_global->__pyx_kp_u_already_exists;
    __pyx_t_6 = __Pyx_PyUnicode_Join(__pyx_t_5, 3, 9 + __Pyx_PyUnicode_GET_LENGTH(__pyx_t_4) + 15, 127 | __Pyx_PyUnicode_MAX_CHAR_VALUE(__pyx_t_4));
 ...
 *     variables[name] = None             # <<<<<<<<<<<<<<
*/
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_variables); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (unlikely((PyObject_SetItem(__pyx_t_1, __pyx_v_name, Py_None) < 0))) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
namespace {
  ...
  #endif
  {
      ...
      "variables",
      __pyx_k_Global_variable_storage_for_ICTL, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
#endif
{
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "variables" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_variables", 0);
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "variables")) {
      if (unlikely((PyDict_SetItemString(modules, "variables", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_variables, __pyx_t_2) < (0)) __PYX_ERR(0, 9, __pyx_L1_error)
 ...
 *     if name in variables:
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9variables_1new_variable, 0, __pyx_mstate_global->__pyx_n_u_new_variable, NULL, __pyx_mstate_global->__pyx_n_u_variables, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_new_variable, __pyx_t_2) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{9},{15},{26},{20},{18},{18},{8},{13},{5},{8},{10},{4},{8},{12},{3},{12},{12},{10},{8},{6},{9},{33}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (204 bytes) */
const char* const cstring = "(\265/\375`\014\000\025\006\000\022\315)\037\240\355\267\252*\353\366\263\325\023+\245\226 \317b\300\251R\302\324,\350\277qXzV\370\373\005t\264DH$\002s+i\251\220\007y\305b07\221\021w(\004'\020\346\337\227v\356:\277v\327w\323\352)\375Y\177v\277to\356Z\246\271\367\030\305\356\1777\225a\356\356\330R\314=c\257\255g\353\356\025\357\312\375\252t\372J9\355\330\372c{k~l\365\316\270\254\"\231\255\030\314\264\372H\177\357\270\256\266\371\300\307\035\324\220\334%\031[}\355\236\374\352j\263\316\366{\003\244\350s\227\032\306\337\211Z\216JK\010\000\370L\031J\345\3473\344\340\021g\312\306\274T\261_ \2212\245\007";
    PyObject *data = __Pyx_DecompressString(cstring, 204, 3);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (205 bytes) */
const char* const cstring = "x\332E\2161N\003A\014E\205\024\2114\341\014\313\005\302\001RP@\215\002\005\355\227w\326\021\243xgv\3273\311n\227rJ\312\2249VJ\216\202%\222`\311O\226\374,\377\347O\032<\325\302UE205S\305\243\327\244\336%A\235\275$\037\364iw\261t\331M\300z\032\255_M\301\033\217\351\2037\244Sp>.]\034b\266\013V'F\370\2004\220\343\232\334\026\330\344\340\000x\305\315\363\211[\005Z2\323\252\215M\026\006\002\265\377\344=\256\377\273\330\001}&\371[\001\312\351\242\331\324X\220,\tH\254\306\035If\275E?\334\375\314\356\017\271\274\224\376<\177(r|<\256Nt\352\317\263Ey/_\337\364\013\367\255k\242";
    PyObject *data = __Pyx_DecompressString(cstring, 205, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (268 bytes) */
const char* const bytes = "?Variable  already existsictl_builtins/variables.py__Pyx_PyDict_NextRefasyncio.coroutinescline_in_traceback__func___is_coroutineitems__main____module__name__name__new_variablepop__qualname____set_name__setdefault__test__valuesvariables\200\001\340\004\007\200u\210C\210q\330\010\016\210l\230!\230;\240a\240q\330\004\r\210Q\210h\220a";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_ictl_builtins_variables_py, __pyx_mstate->__pyx_n_u_new_variable, __pyx_mstate->__pyx_kp_b_iso88591_uCq_l_aq_Qha, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
