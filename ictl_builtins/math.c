...
static const char __pyx_k_Math_operations_for_ICTL_includi[] = "Math operations for ICTL including evaluation, comparison, and advanced math.";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_4math_math_sympy(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_expr); /* proto */
static PyObject *__pyx_pf_4math_2math_numpy(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_expr); /* proto */
static PyObject *__pyx_pf_4math_4math_random(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_min_val, PyObject *__pyx_v_max_val); /* proto */
static PyObject *__pyx_pf_4math_6math_compare(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, PyObject *__pyx_v_symbol, PyObject *__pyx_v_b); /* proto */
static PyObject *__pyx_pf_4math_8math_eval(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_expr); /* proto */
...
#define __pyx_kp_u_ictl_builtins_math_py __pyx_string_tab[2]
#define __pyx_n_u_MathInternal __pyx_string_tab[3]
#define __pyx_n_u_PyEval __pyx_string_tab[4]
...
#define __pyx_n_u_expr __pyx_string_tab[10]
#define __pyx_n_u_func __pyx_string_tab[11]
#define __pyx_n_u_ictl_builtins_math_engine_MathIn __pyx_string_tab[12]
#define __pyx_n_u_ictl_builtins_math_engine_PyEval __pyx_string_tab[13]
...
#define __pyx_n_u_math __pyx_string_tab[17]
#define __pyx_n_u_mathEngine __pyx_string_tab[18]
#define __pyx_n_u_math_compare __pyx_string_tab[19]
#define __pyx_n_u_math_engine __pyx_string_tab[20]
#define __pyx_n_u_math_eval __pyx_string_tab[21]
#define __pyx_n_u_math_numpy __pyx_string_tab[22]
#define __pyx_n_u_math_pyeval __pyx_string_tab[23]
#define __pyx_n_u_math_random __pyx_string_tab[24]
#define __pyx_n_u_math_sympy __pyx_string_tab[25]
#define __pyx_n_u_max_val __pyx_string_tab[26]
#define __pyx_n_u_min_val __pyx_string_tab[27]
...
#define __pyx_n_u_symbol __pyx_string_tab[34]
...
#define __pyx_kp_b_iso88591_3ha __pyx_string_tab[38]
#define __pyx_kp_b_iso88591_Zq __pyx_string_tab[39]
#define __pyx_kp_b_iso88591_k __pyx_string_tab[40]
...
/* Python wrapper */
static PyObject *__pyx_pw_4math_1math_sympy(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyDoc_STRVAR(__pyx_doc_4math_math_sympy, "Evaluate expression using SymPy symbolic math library.");
static PyMethodDef __pyx_mdef_4math_1math_sympy = {"math_sympy", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4math_1math_sympy, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_4math_math_sympy};
static PyObject *__pyx_pw_4math_1math_sympy(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "math_sympy", 0) < (0)) __PYX_ERR(0, 14, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("math_sympy", 1, 1, 1, i); __PYX_ERR(0, 14, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("math_sympy", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 14, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("math.math_sympy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4math_math_sympy(__pyx_self, __pyx_v_expr);
...
static PyObject *__pyx_pf_4math_math_sympy(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_expr) {
...
*/
  ...
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_math_pyeval); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_math_sympy); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 16, __pyx_L1_error)
...
/* Python wrapper */
static PyObject *__pyx_pw_4math_3math_numpy(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_4math_2math_numpy, "Evaluate expression using NumPy numerical library.");
static PyMethodDef __pyx_mdef_4math_3math_numpy = {"math_numpy", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4math_3math_numpy, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_4math_2math_numpy};
static PyObject *__pyx_pw_4math_3math_numpy(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "math_numpy", 0) < (0)) __PYX_ERR(0, 18, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("math_numpy", 1, 1, 1, i); __PYX_ERR(0, 18, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 1)) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("math_numpy", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 18, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("math.math_numpy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4math_2math_numpy(__pyx_self, __pyx_v_expr);
...
static PyObject *__pyx_pf_4math_2math_numpy(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_expr) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_math_pyeval); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_math_numpy); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = 1;
  #if CYTHON_UNPACK_METHODS
...
/* Python wrapper */
static PyObject *__pyx_pw_4math_5math_random(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_4math_4math_random, "Generate random integer between min_val and max_val (inclusive).");
static PyMethodDef __pyx_mdef_4math_5math_random = {"math_random", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4math_5math_random, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_4math_4math_random};
static PyObject *__pyx_pw_4math_5math_random(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "math_random", 0) < (0)) __PYX_ERR(0, 22, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("math_random", 1, 2, 2, i); __PYX_ERR(0, 22, __pyx_L3_error) }
      }
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("math_random", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 22, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("math.math_random", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4math_4math_random(__pyx_self, __pyx_v_min_val, __pyx_v_max_val);
...
static PyObject *__pyx_pf_4math_4math_random(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_min_val, PyObject *__pyx_v_max_val) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_mathEngine); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_math_random); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 24, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = 1;
  #if CYTHON_UNPACK_METHODS
  ...
  #endif
  {
    PyObject *__pyx_callargs[3] = {__pyx_t_2, __pyx_v_min_val, __pyx_v_max_val};
...
/* Python wrapper */
static PyObject *__pyx_pw_4math_7math_compare(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_4math_6math_compare, "Compare two values using a comparison operator.");
static PyMethodDef __pyx_mdef_4math_7math_compare = {"math_compare", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4math_7math_compare, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_4math_6math_compare};
static PyObject *__pyx_pw_4math_7math_compare(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "math_compare", 0) < (0)) __PYX_ERR(0, 26, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("math_compare", 1, 3, 3, i); __PYX_ERR(0, 26, __pyx_L3_error) }
      }
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("math_compare", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 26, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("math.math_compare", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4math_6math_compare(__pyx_self, __pyx_v_a, __pyx_v_symbol, __pyx_v_b);
...
static PyObject *__pyx_pf_4math_6math_compare(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a, PyObject *__pyx_v_symbol, PyObject *__pyx_v_b) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_mathEngine); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_math_compare); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = 1;
  #if CYTHON_UNPACK_METHODS
  ...
  #endif
  {
    PyObject *__pyx_callargs[4] = {__pyx_t_2, __pyx_v_a, __pyx_v_symbol, __pyx_v_b};
...
/* Python wrapper */
static PyObject *__pyx_pw_4math_9math_eval(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_4math_8math_eval, "Evaluate a mathematical expression.");
static PyMethodDef __pyx_mdef_4math_9math_eval = {"math_eval", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_4math_9math_eval, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_4math_8math_eval};
static PyObject *__pyx_pw_4math_9math_eval(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "math_eval", 0) < (0)) __PYX_ERR(0, 30, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("math_eval", 1, 1, 1, i); __PYX_ERR(0, 30, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 1)) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("math_eval", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 30, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("math.math_eval", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4math_8math_eval(__pyx_self, __pyx_v_expr);
...
static PyObject *__pyx_pf_4math_8math_eval(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_expr) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_mathEngine); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_math_eval); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_5 = 1;
  #if CYTHON_UNPACK_METHODS
...
namespace {
  ...
  #endif
  {
      ...
      "math",
      __pyx_k_Math_operations_for_ICTL_includi, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
 ...
 * 
*/
  __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_ictl_builtins_math_engine_MathIn, 0, 0, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_math_engine);
  Py_DECREF(__pyx_t_1);
  if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_t_1 = __pyx_t_3;
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_MathInternal);
  Py_DECREF(__pyx_t_1);
  if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_t_1 = __pyx_t_3;
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_mathEngine, __pyx_t_2) < (0)) __PYX_ERR(0, 10, __pyx_L1_error)
 ...
 * # Tunnel all math operations into mathEngine (eval, compare, random) and PyEval (sympy, numpy)
*/
  __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_ictl_builtins_math_engine_PyEval, 0, 0, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_math_engine);
  Py_DECREF(__pyx_t_1);
  if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_t_1 = __pyx_t_3;
  __pyx_t_3 = __Pyx_ImportFrom(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_PyEval);
  Py_DECREF(__pyx_t_1);
  if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_t_1 = __pyx_t_3;
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_math_pyeval, __pyx_t_2) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     return math_pyeval.math_sympy(expr)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4math_1math_sympy, 0, __pyx_mstate_global->__pyx_n_u_math_sympy, NULL, __pyx_mstate_global->__pyx_n_u_math, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_math_sympy, __pyx_t_2) < (0)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     return math_pyeval.math_numpy(expr)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4math_3math_numpy, 0, __pyx_mstate_global->__pyx_n_u_math_numpy, NULL, __pyx_mstate_global->__pyx_n_u_math, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_math_numpy, __pyx_t_2) < (0)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     return mathEngine.math_random(min_val, max_val)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4math_5math_random, 0, __pyx_mstate_global->__pyx_n_u_math_random, NULL, __pyx_mstate_global->__pyx_n_u_math, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_math_random, __pyx_t_2) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     return mathEngine.math_compare(a, symbol, b)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4math_7math_compare, 0, __pyx_mstate_global->__pyx_n_u_math_compare, NULL, __pyx_mstate_global->__pyx_n_u_math, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[3])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_math_compare, __pyx_t_2) < (0)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     return mathEngine.math_eval(expr)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4math_9math_eval, 0, __pyx_mstate_global->__pyx_n_u_math_eval, NULL, __pyx_mstate_global->__pyx_n_u_math, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[4])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_math_eval, __pyx_t_2) < (0)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{1},{21},{12},{6},{20},{1},{18},{1},{18},{4},{8},{38},{32},{13},{5},{8},{4},{10},{12},{11},{9},{10},{11},{11},{10},{7},{7},{10},{8},{3},{12},{12},{10},{6},{8},{6},{15},{17},{13},{13}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (276 bytes) */
const char* const cstring = "(\265/\375`\272\000U\010\000RO0&pMs\374\377\377\327\333\236\275\243\303\224p\311\332\310\312\232\006\213\244\3552\306\300AJ\274\304`\021\303\354\364\337U\237\204:\250\031\217\002P5\237\311\2020\025Q\t\265r\000\025\352\240R<\211\216 \020\002p\"\317\313\310\362oOr4\3126\327\302\223\344\370\267\235\232\037>\370\263\333\376\177nsz\356o\366\212F\367\246^\212B\n\335l\246\026\272\267\032\177\263u\177t,\331#\213\270\331\245\371\321\277zZ~\nV\234Y+\361ZJ\276\331\333\222\"7\223\363QoE\217\255\246q\327\302\022Y1\344r1FE#\177\333M\203F\3326\305\262\035\017\n#\214\\g\210\315dcSz\223\213-\242\036  \206Xg7\340\320\004r\210\024,\306\325[\236\366\226\210Uk\277\265ak^@\264Z\277\247\255-\203\360\031$_\353l \207\334E\360\024\276\335\312<\222A\332\006\265d\306b\301r`9\200<`\021\260\360";
    PyObject *data = __Pyx_DecompressString(cstring, 276, 3);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (320 bytes) */
